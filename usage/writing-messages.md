...
Once you have all your segments added, you can create your EDI message content like so:
...
Alternatively if you already have all your segments ready you can create an instance, and then cast it to a string to serialize:
